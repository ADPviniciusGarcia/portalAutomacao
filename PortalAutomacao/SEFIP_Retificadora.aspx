...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="border: 2px solid #cccccc;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtColaboradores" runat="server" Columns="4" Width="500px"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Text="*" ControlToValidate="txtColaboradores"
                    Display="dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
         <tr>
